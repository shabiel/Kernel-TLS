XWBTCPM2 ;ISF/RWF - BROKER Other Service ;2015-08-23  5:03 PM
 ;;1.1;RPC BROKER;**43,45,53,59,ven/smh**;Mar 28, 1997;Build 2
...
WBF ;Buffer Flush
 ...
 Q
 ;
OPEN(P1,P2,TLS) ;Open the device and set the variables
 D CALL^%ZISTCP(P1,P2,,TLS) Q:POP
 S XWBTDEV=IO
 Q
 ;
