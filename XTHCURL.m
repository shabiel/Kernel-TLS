XTHCURL	;HCIOFO/SG - HTTP 1.0 CLIENT (URL TOOLS) ;2016-05-24  1:01 PM
	;;7.3;TOOLKIT;**123,ven/smh**;Apr 25, 1995;Build 4
...
MAKEURL(HOST,PORT,PATH,QUERY)	;
	...
	;
	; PATH          Source path
	; ven/smh: change below to fix bug
	;
NORMPATH(PATH)	;
	N LAST
	...
	;I LAST'="",LAST'["?",LAST'["."  S PATH=PATH_"/" ; ven/smh commented out
	Q PATH
	;
	...
	;            0  Ok
	;
PARSEURL(URL,HOST,PORT,PATH,ISTLS)	;
	...
	S:PORT'>0 PORT=$S(ISTLS:443,1:80)
	Q 0
