XTHC10	;HCIOFO/SG - HTTP 1.0 CLIENT ;2016-05-23  9:01 AM
	;;7.3;TOOLKIT;**123,566,ven/smh**;Apr 25, 1995;Build 6
	;
	; VEN/SMH - TLS Support!
	Q
	;
...
GETURL(URL,XT8FLG,XT8RDAT,XT8RHDR,XT8SDAT,XT8SHDR,REDIR)	;
	...
	. ;--- Resolve the host name into the IP address(es) (but not on GT.M -- does it at runtime)
	. I OS["GT.M" S IPADDR=HOST
	...
	. D CALL^%ZISTCP(IP,PORT,+XT8FLG,ISTLS)
